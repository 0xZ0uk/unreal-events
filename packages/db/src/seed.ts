...
export const SEED_VENUES = [
	...
	{
		name: "m|i|mo - museu da imagem em movimento",
		slug: "mi-mo-museu-da-imagem-em-movimento",
	},
	{
		name: "Biblioteca Municipal Afonso Lopes Vieira",
		slug: "biblioteca-municipal-afonso-lopes-vieira",
	},
	{
		name: "Ludoteca Municipal de Leiria",
		slug: "ludoteca-municipal-de-leiria",
	},
...
if (import.meta.main) {
	...
	console.log(`VENUES_SEEDED new=${res.rowsAffected} total=${res.totalVenues}`);
}
