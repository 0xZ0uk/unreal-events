...
function Card({
	...
	return (
		<div
			...
			data-size={size}
			className={cn(
				"group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-[8px] bg-card py-(--card-spacing) text-sm/relaxed text-card-foreground ring-1 ring-foreground/[0.08] shadow-[0_5px_10px_rgba(0,0,0,0.04)] [--card-spacing:--spacing(4)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-[8px] *:[img:last-child]:rounded-b-[8px]",
				className,
			)}
			{...props}
		/>
