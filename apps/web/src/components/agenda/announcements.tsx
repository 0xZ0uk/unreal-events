...
export function Announcements({ agenda }: { agenda: Agenda }) {
	...
	return (
		<section aria-labelledby="anuncios" className="mt-20 border-t border-border pt-10">
			<h2 id="anuncios" className="p443-section-title">
				Datas por confirmar
			</h2>
			<p className="mt-3 max-w-[54ch] text-[15px] leading-relaxed text-muted-foreground">
				Anunciados pelas fontes, ainda sem dia marcado. Passam para a agenda assim que a data aparecer.
			</p>
			...
			<p className={`${MICRO} mt-6 text-muted-foreground`}>{agenda.announcements.length} por confirmar</p>
		</section>
	);
}
